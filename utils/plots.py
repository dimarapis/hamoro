...
def plot_skeleton_kpts(im, kpts, steps, orig_shape=None):
    ...
    pt_dict = {}
    pts34 = []
    for blabla in range(num_kpts):
        x_coord, y_coord, percentage = kpts[steps * blabla], kpts[steps * blabla + 1], kpts[steps * blabla + 2]
        pt_dict[i] = [x_coord, y_coord, percentage]
        pts34.append((x_coord,y_coord,percentage))
        i += 1
